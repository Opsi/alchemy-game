...
//     tooltip:
//       'You learn the potion recipe "Vision Potion". This potion increases the chance to find ingredients.',
//     type: "skill",
...
//     tooltip:
//       'You learn the potion recipe "Vision Potion". This potion increases the ingredient search speed.',
//     type: "skill",
//     priceTag: "5 Knowledge",
//     logMessage: "TODO!!!",
//     learnable: (state: State) => state.experiment.total.knowledge > 0,
...
//     return state.skill;
//   }
//   const newUnknown = state.skill.unknown.filter(
//     (skill) => !skill.learnable(state)
//   );
//   const newKnown = state.skill.unknown.filter((skill) =>
//     skill.learnable(state)
//   );
//   return {
//     ...state.skill,
//     unknown: newUnknown,
